...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              $array1 = array("CA","DE","GR","IT","GB","US");
              for($i = 0 ; $i < count($countries); $i++){
                  $index = $array1[$i];
                  echo '<a href="list.php?country='."$countries[$index]".'" role="button" class="btn btn-default"> '.$countries[$index].'</a>';
              }
   ...
   //              </a>
			// </li>
//          for($i = 0 ; $i < )
          $index = array(22,54,7,19,46,6,60,58,75,77,27,2,24,13,101,102);
          for($j = 0 ; $j < count($images) ; $j++){
              echo '<li>'.'<a href="detail.php?id='."$index[$j]".'" class="img-responsive">'.'<img src="images/square/'
                  .$images[$index[$j]]["path"].'" alt="'.$images[$index[$j]]["title"].'">'
              .'<div class="caption"> <div class="blur"></div> <div class="caption-text"> <h1>'.$images[$index[$j]]["title"].'</h1></div></div></a>';
          }
          ?>
